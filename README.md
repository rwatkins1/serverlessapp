...
A serverless web application using AWS services and Terraform for infrastructure as code demonstrating how to build a scalable, secure, cost efficient application without managing traditional servers. 
